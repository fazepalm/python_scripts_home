...
def getSetShuffleVariables( CG_SHUFFLE, CG_count, rootNode, rootXpos, rootYpos ):
    ...
    print CG_SHUFFLE.name(), CG_SHUFFLE_X_VAL
        ...
        if CG_PASSES == 1:
            if CG_CHANNEL_LIST != []:
                ...
                if nuke.exists( CG_Dot_02.name() ):
                    ...
                    shuffleFromList( CG_PASS_LIST_01, CG_Dot_02, CG_DotXPos_02, CG_DotYPos_02  )
                    shuffleFromList( CG_PASS_LIST_02, CG_Dot_03, CG_DotXPos_03, CG_DotYPos_03  )

        #breakout UTIL
        if UTIL == 1:
            if UTIL_CHANNEL_LIST != []:
                shuffleFromList( UTIL_CHANNEL_LIST, UTIL_Dot_01, UTIL_DotXPos_01, UTIL_DotYPos_01  )
