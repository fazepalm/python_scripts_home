...
def shuffleFromList( CG_PASS_LIST, rootNode_01, rootXpos_01, rootYpos_01, useCount ):
    shuffleDict = {}
    shuffleVarList = []
...
#                                    L_SHUFFLE_MERGE = nuke.toNode( L_SHUFFLE_MERGE_NAME )
        ...
        if CG_PASSES == 1:
            if CG_CHANNEL_LIST != []:
                ...
                if nuke.exists( CG_Dot_02.name() ):
                    ...
                    CG_PASS_DICT_01 = shuffleFromList( CG_PASS_LIST_01, CG_Dot_02, CG_DotXPos_02, CG_DotYPos_02, useCount = True  )
                    ...
                    CG_PASS_DICT_02 = shuffleFromList( CG_PASS_LIST_02, CG_Dot_03, CG_DotXPos_03, CG_DotYPos_03, useCount = True  )
        ...
        if UTIL == 1:
            if UTIL_CHANNEL_LIST != []:
                UTIL_PASS_DICT_01 = shuffleFromList( UTIL_CHANNEL_LIST, UTIL_Dot_01, UTIL_DotXPos_01, UTIL_DotYPos_01, useCount = False  )
